var quoteHolder = document.getElementById("text");

var authorHolder = document.getElementById("author");

var backgroundContainer = document.getElementById("backgroundContainer");

var backgrounds = ["url('Assets/alex-green-OdEdGWr0EkM-unsplash.jpg')", 
...
function genQuote() {
    axios.get('https://gist.githubusercontent.com/camperbot/5a022b72e96c4c9585c32bf6a75f62d9/raw/e3c6895ce42069f0ee7e991229064f167fe8ccdc/quotes.json') //This is the api.
        .then((body) => {
            var rand = Math.floor(Math.random() * body.data.quotes.length); //do .length instead of 10 
            var quoteText = "\"" + body.data.quotes[rand].quote + "\"";
            var authorText = body.data.quotes[rand].author;
